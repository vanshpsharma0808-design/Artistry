    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <button
              ...
              className="md:hidden text-salon-gold transition-transform duration-300 hover:scale-110"
      ...
      <div className="fixed bottom-6 right-6 z-50 hidden md:block">
        <a
          ...
          className="w-14 h-14 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-all duration-300"
